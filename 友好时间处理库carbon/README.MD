...
- [carbon 一个友好的时间处理库](#carbon-一个友好的时间处理库)
  - [下载](#下载)
- [用法示例](#用法示例)
  - [昨天、今天、明天](#昨天今天明天)
  - [创建 Carbon 实例](#创建-carbon-实例)
  - [将标准格式时间字符串解析成 Carbon 实例](#将标准格式时间字符串解析成-carbon-实例)
  - [通过格式化字符将字符串解析成 Carbon 实例](#通过格式化字符将字符串解析成-carbon-实例)
  - [通过布局字符将字符串解析成 Carbon 实例](#通过布局字符将字符串解析成-carbon-实例)
  - [Carbon 和 time.Time 互转](#carbon-和-timetime-互转)
  - [开始时间、结束时间](#开始时间结束时间)
  - [时间旅行](#时间旅行)
  - [时间差](#时间差)
  - [时间判断](#时间判断)
